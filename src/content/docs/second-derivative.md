...
As mentioned in [derivative notation](/derivative-notation), the second
derivative of a *function* $f(x)$ can be written as:

$$
f''(x)
$$

If we just have a polynomial $y$ (in terms of $x$) then the second derivative is
written as:
...
To find the second derivative we just differentiate it... and then differentiate
it again!
