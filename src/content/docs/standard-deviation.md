...
As mentioned in the [variance](/variance) page, variance is just the standard
...
1. Find the [variance](/variance) of the set of numbers.
...
If we want to substitute our formulae for [variance](/variance) into this, we
can get any of:
