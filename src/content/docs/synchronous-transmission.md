...
This does mean that the sender and receiver need to be synchronized to the same
clock signal, and they need to always be listening to the clock signal, even 
when no data is being sent.

The advantage though is that, once they're synchronized, they can just *send
