...
Importantly, there are gaps between the possible values of a discrete variable.
(if it's a number)
For example, if we have a variable which can only take on the values 1, 2, and
3, then it cannot take on the value 1.5, or 2.7, or any other value between 1
and 3 - they're gaps.
...
- The number of people in a room is a discrete variable, because it can only
  take on whole number values (0, 1, 2, 3, etc.). It can't be fractional
  values like 1.5 or 2.7.
