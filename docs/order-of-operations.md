...
> Note: When we have multiple operations of the same rank (e.g. both division
...
- First, we do the division: $4 \div 2 = 2$.
...
- Next, we do the division: $16 \div 2 = 8$.
...
- Then, we do the division: $8 \div 2 = 4$.
