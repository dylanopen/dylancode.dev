...
Knowing that the bearing starts from the line extending to the right, we can
say that:
- The line going to the right from the origin is at a bearing of $0\pi$ radians
- The line going upwards from the origin is at a bearing of $\frac12\pi$ radians
- The line going to the left from the origin is at a bearing of $\pi$ radians
- The line going downwards from the origin is at a bearing of $\frac32\pi$
  radians
