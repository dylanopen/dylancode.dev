...
### Convert $\pmatrix{7\\2\\3}=\lambda\pmatrix{0\\5\\2}$ to cartesian form
...
- Direction vector $\vec d = \pmatrix{5-2\\8-3\\5-(-2)}=\pmatrix{3\\5\\7}$
- Vector equation: $\vec r = \pmatrix{2\\3\\-2} + \lambda \pmatrix{3\\5\\7}$
