...
We usually use the letter $f$ to represent frequency. Nice and simple :)
...
Frequency can be calculated using the re-arranged formula for
[wavelength](/wavelength) and [wave speed](/wave-speed):
...
- $\lambda$ is the [wavelength](/wavelength) of the wave (in metres, $m$)

## Relationship with wavelength

It is *inversely proportional* to the [wavelength](/wavelength) of the wave -
