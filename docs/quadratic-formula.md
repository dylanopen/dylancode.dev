...
[the page on the discriminant](/discriminant) for more information.

## Finding the roots

To find the roots of a quadratic equation using the quadratic formula, we
substitute the coefficients of the equation into the quadratic formula.
