...
- $y > 10$ (this is an inequality, not an expression)
- $4 \times$ (this is incomplete and not a valid expression)
...
For example, in the term $4x^3$, the coefficient is $4$, meaning that $x^3$ is
multiplied by $4$.
