...
If we save this code in a file called `example.c`, then `example.c` is the
...
> In short, source code is the code we write, before it's compiled or
> interpreted into a form that the computer can execute.
