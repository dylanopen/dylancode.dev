...
We write the dimensions of a matrix as $m \times n$, where $m$ is the number of
...
3 rows has dimensions $3 \times 1$.
...
square matrix with 4 rows and 4 columns has dimensions $4 \times 4$.
