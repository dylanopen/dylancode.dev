...
To combine like terms, we need to know a fundamental rule:
...
### Simplify $6a - 4a + 2b + 3b - b$

- Find the like terms:
  - $6a$ and $-4a$ are like terms.
  - $2b$, $3b$, and $-b$ are like terms.
- Combine the like terms:
  - $6a - 4a = (6 - 4)a = 2a$
  - $2b + 3b - b = (2 + 3 - 1)b = 4b$
- Write the simplified expression:
...
### Simplify $5m + 2n - 3m + 4 - n + 7 - 4n^2$

- Find the like terms:
  - $5m$ and $-3m$ are like terms.
  - $2n$ and $-n$ are like terms.
  - $4$ and $7$ are like terms (constants).
  - $-4n^2$ has no like terms.
- Combine the like terms:
  - $5m - 3m = (5 - 3)m = 2m$
  - $2n - n = (2 - 1)n = 1n = n$
  - $4 + 7 = 11$
