...
subtracting that angle from $180\degree$.
...
The sine function has a period of $360\degree$. This means that every interval
of $360\degree$, the sine function repeats its values. 

This means that we can add or subtract $360\degree$ any number of times to find
more solutions to sine equations:
