...
> We can find the [[mode]] by [differentiating](power-rule-for-differentiation) the [[probability-density-function]] of the variable and then finding the value that gives us the maximum value of the PDF.
