...
- The *normal* is an imaginary line that is perpendicular (at 90°) to the
  surface where the light ray hits.

## Laws of reflection

- The angle of incidence is equal to the angle of reflection.
- This means that the angle at which the light ray hits the surface is the same
