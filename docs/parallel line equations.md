...
From this knowledge, we can find the equation of any line if we know that it's 
parallel to a line that we know, and we know a point that the new line goes
through.
...
- We can substitute these values into the equation of a straight line:
  ...
  - $c = 5 - 8$
  - $c = -3$
- The $y-intercept$ ($c$) is $-3$, so write the equation for a line with
...
- We can substitute these values into the equation of a straight line:
  ...
  - $c = 1 + 3$
  - $c = 4$
- The y-intercept ($c$) is $4$, so write the equation for a line with
  gradient $-\frac{1}{2}$ and $y-intercept$ $4$:
  - $y = -\frac{1}{2}x + 4$
...
- We can substitute these values into the equation of a straight line:
  ...
  - $c = 7 - 6$
  - $c = 1$
- The -intercept ($c$) is $1$, so write the equation for a line with
