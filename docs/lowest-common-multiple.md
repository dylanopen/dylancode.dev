...
The LCM (lowest common multiple) of numbers is the *smallest multiple that is
common to both/all numbers*.

In other words, it's the smallest number that both/all numbers go into.

For example, the LCM of $12$ and $16$ is $48$, because $48$ is the smallest
number that both $12$ and $16$ go into.

## Finding the lowest common multiple

To find the lowest common multiple, you need to be familiar with
[prime factorisation](prime-factorisation).

Here are the steps:
1. Find the prime factorisation of each number.
2. For each different prime factor, take the highest power of that factor that
