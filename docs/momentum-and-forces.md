...
momentum of the object (the [impulse](/impulse)) is the force multiplied by the
...
- $\Delta mv$ is the change in momentum in kilogram meters per second
  ($kgms^{-1}$). Otherwise known as the [impulse](/impulse).
...
- The y-axis will show the force, in Newtons ($N$)
- The x-axis will show the time, in seconds ($s$)
