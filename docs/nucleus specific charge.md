...
- The [[charge]] can be found by multiplying the number of *protons* by the charge of the [[proton]].
    - We ignore the [[neutron]]s because they have no charge.
- The [[mass]] is found by taking the [[nucleon number]] (mass number), or adding the number of [[proton]]s and [[neutron]]s, then multiplying by the mass of a proton/neutron, $1.67\times10^{-27}$ 
