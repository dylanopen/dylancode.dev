...
With that rule in mind, we can just use logic to think 'what do I need to do in
order to get the variable on its own?'

> Note: for a note explaining how to *rearrange* equations, see
> [rearranging-equations.md](/rearranging-equations).
