...
> Metadata is information about an image which is not part of the image data
> itself.

## What's stored in metadata?

- The image's [[bitmap resolution|resolution]]
- The [[bitmap colour depth|colour depth]] of the image (i.e. how many different colours it can display)
