...
- A *displacement-time graph* is a graph which shows:
  - the [displacement](/displacement) travelled by an object on the y-axis
  - the [time](/time) on the x-axis.
- They tell us how far away from its starting position an object has travelled
...
To find the velocity of an object from a displacement-time graph, we need
...
we want to find the velocity, and then find the gradient of that tangent line.
