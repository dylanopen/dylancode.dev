...
The **distributive law** of [[booleans]] ORing says whenever we have a [[boolean expression]] of the form $A \cdot (B + C)$, we can distribute the [[boolean and|AND]] over the [[boolean or|OR]] to get $A \cdot B + A \cdot C$.
...
Or, you can just think of it like how you '[[expanding brackets|expand brackets]]' in maths, it works basically the same way.

This also works the other way around, we can [[factorising|factor out]] the $A$ from $A \cdot B + A \cdot C$ to get $A \cdot (B + C)$.
