...
![[res/photoelectric effect graph.png|Graph showing the results of max kinetic energy of electrons, plotted against the frequency of the incident light]]
...
- The *gradient* of the graph is [[planck constant|Planck's constant]] ($h$).
    - That's because, if we rearrange the equation for the energy of a photon ($E=h\times f$) to find the kinetic energy of the emitted electron, we get:
    - $h=\frac Ef$
