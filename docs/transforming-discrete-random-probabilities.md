...
If we didn't square $a$, we'd be finding the [[standard-deviation]]. If we want to find the variance from the standard deviation, then we'll need to **square the result**.
