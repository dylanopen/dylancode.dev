...
Solving that [[integration|integral]] between any two values for $a$ and $b$ will give us the probability of a [[continuous random variable]] (following that [[probability density function]]) taking on a value between $a$ and $b$.
