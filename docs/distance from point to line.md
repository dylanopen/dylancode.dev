...
| Given $l_1: r=\begin{pmatrix}1\\1\\-3\end{pmatrix}+\lambda\begin{pmatrix}2\\-2\\-1\end{pmatrix}$ and $A=(1,2,-1)$, what is $\vec{AB}$ as a function of $\lambda$? | $\vec{AB} = \begin{pmatrix}2\lambda\\-1-2\lambda\\-2-\lambda\end{pmatrix}$ |
| For $l_1: r=\begin{pmatrix}1\\1\\-3\end{pmatrix}+\lambda\begin{pmatrix}2\\-2\\-1\end{pmatrix}$ and $A=(1,2,-1)$, what is the value of $\lambda$ for the foot of the perpendicular? | $\lambda = -\frac{4}{9}$ |
| For $l_1: r=\begin{pmatrix}1\\1\\-3\end{pmatrix}+\lambda\begin{pmatrix}2\\-2\\-1\end{pmatrix}$ and $A=(1,2,-1)$, what is the length of the perpendicular distance? | $\frac{\sqrt{29}}{3}$ |
| For the problem $l: r=\begin{pmatrix}1\\0\\2\end{pmatrix}+\lambda\begin{pmatrix}3\\-1\\4\end{pmatrix}$ and $A=(2,3,4)$, what is $\vec{AB}$ as a function of $\lambda$? | $\vec{AB} = \begin{pmatrix}3\lambda-1\\-3-\lambda\\4\lambda-2\end{pmatrix}$ |
| For $l: r=\begin{pmatrix}1\\0\\2\end{pmatrix}+\lambda\begin{pmatrix}3\\-1\\4\end{pmatrix}$ and $A=(2,3,4)$, what is the value of $\lambda$ for the foot of the perpendicular? | $\lambda = \frac{4}{13}$ |
| What is the distance from the point $(2,3,4)$ to the line $l: r=\begin{pmatrix}1\\0\\2\end{pmatrix}+\lambda\begin{pmatrix}3\\-1\\4\end{pmatrix}$? | $\frac{5\sqrt{78}}{13}$ |
