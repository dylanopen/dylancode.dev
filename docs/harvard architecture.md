...
> The Harvard architecture is a [[stored program concept|stored program architecture]] where the instructions and data are stored in separate memory regions to each other.

## Where is Harvard used?

- It's mainly used in embedded systems, for example, in digital signal processing (DSP).
- It's not common to use it for a [[general purpose computer|general-purpose computer]].
