...
Most [[peripheral|peripherals]] use serial transmission, primarily the 
...
- There's no [[data skew|skew]] issues, because the bits are sent one after
...
The main disadvantage of serial transmission compared to [[parallel transmission|parallel
transmission]] is that it can be slower than parallel
