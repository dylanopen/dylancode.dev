...
- We can substitute these values into the [[equation of a straight line]]:
  ...
  - $c = 5 + 2$
  - $c = 7$
- The y-intercept ($c$) is $7$, so write the equation for a line with gradient
  $-\frac{1}{2}$ and y-intercept $7$:
  - $y = -\frac{1}{2}x + 7$
