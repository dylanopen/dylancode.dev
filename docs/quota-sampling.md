...
Quota sampling is identical to [stratified sampling](/stratified-sampling)
except that instead of sampling from each group at random, we sample based on
convenience.

For example, if we're surveying people in a shopping mall, we might divide the
...
See [stratified sampling](/stratified-sampling) for a full explanation of how
the groups are made and how we know how many people to survey from each group.
