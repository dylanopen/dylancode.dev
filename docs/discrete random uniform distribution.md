...
It's important to remember our [[standard series results]] when working with discrete random uniform
...
Another reminder of how we [[transforming discrete random probabilities|transform discrete random probabilities]].
